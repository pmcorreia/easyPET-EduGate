...
for i in range(0, numberOfSources):
    if debug:
        print('python SourcesFiles/'+sFile[i]+' '+str(i)+' '+str(positionX[i])+' '+str(positionY[i])+' '+str(positionZ[i])+' '+str(OutputFilesDirectory))
    os.system('python SourcesFiles/'+sFile[i]+' '+str(i)+' '+str(positionX[i])+' '+str(positionY[i])+' '+str(positionZ[i])+' '+str(OutputFilesDirectory))
...
/gate/application/setTimeStop    270 s\n\
\n\
